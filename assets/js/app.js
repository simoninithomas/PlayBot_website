 ...
 ************************************************************************************************************************
 ************************************************************************************************************************/
angular.module('playBotApp', ['playBotApp.controllers', 'ngRoute', 'pascalprecht.translate', 'angulartics', 'angulartics',
    ...
    .config(['$translateProvider', function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            INTRO_TEXT_USER: "PlayBot is an AI on Messenger that <b>suggests games based on your tastes</b>",
            WHY: "Why submit my game ?",


            HEADLINE: "The <b>simpliest way</b> to <b>find success</b> with your mobile game",
            INTRO_TEXT: "PlayBot is a bot on Messenger that <b>suggests games based on user tastes.</b>",
            ...
            WAITING_LIST2 : "Want to chat with PlayBot ?",
            SPEAK_BUTTON: "<i class='fa fa-comments-o' aria-hidden='true'></i> PlayBot find me a good game !",
            ...
            //About
                ...
                STORY:"PlayBot is a bot on Messenger that <b>suggests games based on user tastes</b>.",
            //I found this idea when I was in exams, I wanted to find a way to find good games without spending much time in Google Play
                OUR_TEAM:"Our team",
                TEAM_SIMONINI:"SIMONINI Thomas, Founder of PlayBot",
                TEAM_SIMONINI_BIOGRAPHY:"I'm an entrepreneur, based in Lyon (Jean Moulin's Incubator). Full Stack Developer (NodeJS, Express, AngularJS, MongoDB). I'm passionate about programming and new technologies since I learnt C language when I was 13 years old with the book 'C Programmming Language, 1988' and Visual C++ for Windows 3.1",
        ...
        .translations('fr', {
            ...
            INTRO_TEXT_USER: "PlayBot est une intelligence artificielle sur Messenger qui vous propose <b>gratuitement des jeux adaptés à vos goûts</b>",
            WHY: "Pourquoi soumettre mon jeu ?",



            HEADLINE: "<b>Faire connaître vos jeux </b> n'aura jamais été aussi <b>simple</b>",
            INTRO_TEXT: "PlayBot est un bot sur Messenger qui <b>propose à l'utilisateur des jeux adaptés à ses goûts</b>",
            ...
            WAITING_LIST2 : "Envie de parler à PlayBot ?",
            SPEAK_BUTTON: "<i class='fa fa-comments-o' aria-hidden='true'></i> PlayBot trouve moi un jeu !",
    ...
    .config(function($routeProvider){
            $routeProvider
                ...
                .when('/press',{
                    templateUrl: 'assets/templates/press.html'
                })
                .when('/jobs',{
                    templateUrl: 'assets/templates/jobs.html'
                })
                .when('/termsOfUse',{
                    templateUrl: 'assets/templates/termsOfUse.html'
                })
                .when('/customers',{
                ...
                .when('/thanks',{
                    templateUrl: 'assets/templates/thanks.html'
                })
                .otherwise('/')
